...
echo "Create VM #1"
az vm create -g 'ossdemo-docker' -n ossdemo-svr21 --public-ip-address-dns-name 'ossdemo-svr21-[VAR1]' --os-disk-name 'svr21-disk' \
...
echo "Create VM #2"
az vm create -g 'ossdemo-docker' -n ossdemo-svr22 --public-ip-address-dns-name 'ossdemo-svrl22-[VAR1]' --os-disk-name 'svr22-disk' \
        --image "OpenLogic:CentOS:7.2:latest" --os-type linux  --nsg 'NSG-ossdemo-docker'  --storage-sku 'Premium_LRS' \
        --size Standard_DS2_v2  --availability-set 'ossdemo-docker-availabilityset'  --admin-username GBBOSSDemo  \
        --no-wait \
        --ssh-key-value 'ssh-rsa  rsa-key-20170222'
